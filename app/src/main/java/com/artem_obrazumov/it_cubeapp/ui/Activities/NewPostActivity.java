...
public class NewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.openUntil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void submitPost() {
        ...
        if (validData(title, description)) {
            ...
            if (postType == PostModel.POST_TYPE_CONTEST ||
                ...
                link = binding.inputLink.getText().toString().trim();
            }
            // Получаем ключ поста
            String uid;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_submit:
                ...
                if (binding.publishCheckbox.isChecked()) {
                    // Публикация поста
                    submitPost();
                } else {
