...
public class RequestListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        requestsList = root.findViewById(R.id.requestsList);
    ...
    private void initializeAdapter() {
        ...
        requestsList.setNestedScrollingEnabled(true);
    ...
    private void getRequests() {
        ...
        requestsQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                onTabSelectedListener.onTabSelected(tabs.getTabAt(tabs.getSelectedTabPosition()));
            }
