...
public class CubeInfoEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cube_info_edit);
        ...
        address_input = findViewById(R.id.input_address);
        description_input = findViewById(R.id.input_description);
        imagesList = findViewById(R.id.added_images);
        ...
        ITCubeModel.getCubeQuery(cubeID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    address_input.setText(cube.getAddress());
                    description_input.setText(cube.getDescription());
    ...
    private void initializeRecyclerView() {
        ...
        imagesList.setAdapter(addedImagesAdapter);
    }
    ...
    private boolean validData(String address, String description) {
        if (address.length() < 10) {
            ...
            address_input.setError(getString(R.string.short_address));
            address_input.requestFocus();
            return false;
        }
        if (description.length() < 20) {
            // Слишком короткое описание
            description_input.setError(getString(R.string.short_description));
